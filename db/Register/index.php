            ...
            <div class="login100-pic js-tilt" data-tilt>
              <img src="Sponsor 2.png" alt="IMG">
                ...
                <form class="login100-form validate-form" method="POST" action="index.php">
                  ...
                  <div class="wrap-input100 validate-input" data-validate="Email harus valid cth: ex@abc.xyz">
                  ...
                  <div class="wrap-input100 validate-input" data-validate="Password harus terisi">
                  <input class="input100" type="password" name="ulangpass" placeholder="Ulangi Password">
                  <span class="focus-input100"></span>
                  <span class="symbol-input100">
                    <i class="fa fa-lock" aria-hidden="true"></i>
                  </span>
